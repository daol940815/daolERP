...
export default function PayablesAgingPage() {
  ...
  const load = useCallback(async () => {
    ...
    const res  = await fetch(`/api/reports/payables-aging?${p}`)
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-1">
        <h1 className="text-2xl font-bold text-gray-900">미지급금 경과기간 분석</h1>
      ...
      <div className="flex gap-3 flex-wrap mb-5">
        ...
        <div className="border border-gray-200 rounded-lg px-4 py-3 flex-1 min-w-[140px]">
          <p className="text-xs text-gray-400 mb-1">미지급금 총계</p>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 text-gray-400 text-sm">미지급금이 없습니다.</div>
      ) : (
