...
--   기간은 실제 명절 주문 분포 p1~p99(명절 -35일 ~ +14일)로 캘리브레이션 (2026-08-24,
--   운영 DB에도 동일 값 반영). 날짜 기반 근사이므로 유형 분포는 참고 지표.
...
INSERT INTO crm_seasons (code, label, season_type, year, order_start, order_end) VALUES
  ('24설',   '2024년 설',   'seol',    2024, '2024-01-06', '2024-02-24'),
  ('24추석', '2024년 추석', 'chuseok', 2024, '2024-08-13', '2024-10-01'),
  ('25설',   '2025년 설',   'seol',    2025, '2024-12-25', '2025-02-12'),
  ('25추석', '2025년 추석', 'chuseok', 2025, '2025-09-01', '2025-10-20'),
  ('26설',   '2026년 설',   'seol',    2026, '2026-01-13', '2026-03-03'),
  ('26추석', '2026년 추석', 'chuseok', 2026, '2026-08-21', '2026-10-09')
